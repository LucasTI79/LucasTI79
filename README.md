...
<div style="display:flex;align-items:center;gap:4px">
 ...
 [![My Skills](https://skillicons.dev/icons?i=ts,javascript,adonis,nest,express,nodejs,react,nextjs,docker,nginx,mongodb,postgres,mysql,redis,go,java,kotlin,spring,rabbitmq,git,linux,gcp,azure,aws,heroku)](https://skillicons.dev)
</div> 
