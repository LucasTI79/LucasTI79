...
<div style="display:flex;align-items:center;gap:4px">
 ...
 [![My Skills](https://skillicons.dev/icons?i=ts,javascript,adonis,nest,express,nodejs,react,nextjs,docker,nginx,mongodb,postgres,mysql,redis,go,spring,rabbitmq,git,linux,gcp,azure,aws)](https://skillicons.dev)
</div> 
